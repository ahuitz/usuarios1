...
@NamedQueries({
    ...
    @NamedQuery(name = "Tpersona.findByTGeneroid", query = "SELECT t FROM Tpersona t WHERE t.tGeneroid = :tGeneroid"),
    @NamedQuery(name = "Tpersona.findByTipoSangreid", query = "SELECT t FROM Tpersona t WHERE t.tipoSangreid = :tipoSangreid"),
    @NamedQuery(name = "Tpersona.findByTEstadoid", query = "SELECT t FROM Tpersona t WHERE t.tEstadoid = :tEstadoid"),
...
public class Tpersona implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "TGenero_id", nullable = false)
    private int tGeneroid;
    @Basic(optional = false)
    @Column(name = "TipoSangre_id", nullable = false)
    private int tipoSangreid;
    @Basic(optional = false)
    @Column(name = "TEstado_id", nullable = false)
    private int tEstadoid;
    @Basic(optional = false)
    ...
    public Tpersona(Integer id, String carne, String nombre, String apellido, String direccion, String fechaNac, int tGeneroid, int tipoSangreid, int tEstadoid, int tUsuariosid) {
        this.id = id;
        this.carne = carne;
        this.nombre = nombre;
        ...
        this.tGeneroid = tGeneroid;
        this.tipoSangreid = tipoSangreid;
        this.tEstadoid = tEstadoid;
    ...
    public int getTGeneroid() {
        return tGeneroid;
    }

    public void setTGeneroid(int tGeneroid) {
        this.tGeneroid = tGeneroid;
    }
    ...
    public int getTEstadoid() {
        return tEstadoid;
    }

    public void setTEstadoid(int tEstadoid) {
        this.tEstadoid = tEstadoid;
    }
